...
function tarski_sitetitle() {
    ...
    if ((get_option('show_on_front') == 'posts') && is_home()) {
        // $site_title = sprintf('<div class="sitelink"><a href="http://demo.greatinnovus.com/realestate"><h1 class="logo" style="float:left;" id="blog-title">%s</h1></a>','<p><a href="http://demo.greatinnovus.com/realestate"> WWW.C21Lynch.com</a></p></div>', $site_title);
        // $site_title = sprintf('<div class="sitelink"><p class="logo"><a href="'.get_site_url().'"><span>WWW.C21Lynch.com</span></a></p></div>', $site_title);
        $site_title = sprintf('<div class="sitelink"><p class="logo"><a href="'.get_site_url().'"></a></p></div>', $site_title);
    } else {
        // $site_title = sprintf('<div class="sitelink"><a href="'.get_site_url().'"><p class="logo" style="float:left;" id="blog-title">%s</p></a>','<p> <a href="'.get_site_url().'"> WWW.C21Lynch.com </a></p></div>', $site_title);
		// $site_title = sprintf('<div class="sitelink"><p class="logo"><a href="'.get_site_url().'"><span>WWW.C21Lynch.com</span></a></p></div>', $site_title);
		$site_title = sprintf('<div class ="logo-cont" ><div class="sitelink"><p class=""> <a href="'.get_site_url().'"><img src="'.get_site_url().'/wp-content/themes/realestatenew/images/logo-2.jpg"></a></p></div></div>', $site_title);
...
function tarski_titleandtag() {
    ...
    $callnowvalue = "Lexington, Texas 78947<br /><a href='".get_site_url()."'style='float: right;color:#fff;'><span>sherrillproperties.com</span></a>";
    $callnowlabel = "8653 S Hwy 77 <br />";
	$callnowlabel .= "P.O. 278 <br />";
	$emailnowlabel ="Office: <a style='color:#fff;' href='tel:979 716-4681'>(979) 716-4681</a><br /> <a href='mailto:Sherrill_real_estate@yahoo.com'>Sherrill_real_estate@yahoo.com</a> <br />";
	
	//$emailnowvalue ="<a style='color:#fff;' href='tel:979-542-1715'>Fax: (979) 542-1715</a>";
    if ($title || $tagline  || $callnow || $emailnow)
          echo "<div id=\"title\">\n\t$title\n\t<!--<div class='text_img'></div>--><div id=\"title_bottom\">$callnowlabel\t\t$callnowvalue\n\n<br />$emailnowlabel\t\t$emailnowvalue\n</div></div>\n.<br /> <h1 id='tag-line' style=' font-size: 34px; font-family: Brush Script MT, cursive; padding-top:15px; border-bottom:0px; clear:right; text-align:center;' >Welcome To Lee County Real Estate</h1>";
...
function navbar_wrapper() {
    echo '<div style="clear:both;height:1px;width:100%;" id="navigation" class="clearfix">';
    //th_navbar();
    echo '</div>';
