<?php
/**
 * ZeroGravity constants, functions and definitions
 *
 * @package ZeroGravity
 */
 
$theme = wp_get_theme();
define('ZEROGRAVITY_VERSION', $theme -> get('Version'));
define ('ZEROGRAVITY_AUTHOR_URI', $theme -> get('AuthorURI'));
...
function zerogravity_scripts_styles() {
	...
	wp_enqueue_style( 'zerogravity-style', get_stylesheet_uri(), '', ZEROGRAVITY_VERSION );
	...
	// Toggle search
	wp_enqueue_script('buscar', get_template_directory_uri() .'/js/zg-toggle-search.js', array('jquery'), ZEROGRAVITY_VERSION, true);
}
