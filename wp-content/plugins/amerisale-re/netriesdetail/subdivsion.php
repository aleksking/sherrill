...
$q = strtolower($_GET["q"]);
if (!$q) return;
$divisionsql = "select sub_division from ntreislist where sub_division LIKE  '".$q."%' group by sub_division order by sub_division asc";
...
foreach($divisionres as $divisions){
	...
	$items[$divisions['sub_division']] = $divisions['sub_division'];
}
